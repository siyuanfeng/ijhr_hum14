...
\begin{figure}
  \begin{center}
    {\includegraphics[width=1\textwidth]{images/ladder.eps}}
    \caption{
...
\begin{equation}
  \dot{q}_d^* = \alpha (\dot{q}_d^* + \ddot{q}_d dt) + (1-\alpha) \dot{q}_d,
	\label{eq:qd_int},
\end{equation} 
where $\dot{q}_d^*$ is the desired velocity, $\dot{q}_d$ is the current 
...
is still preferred for higher kinematic model accuracy.
